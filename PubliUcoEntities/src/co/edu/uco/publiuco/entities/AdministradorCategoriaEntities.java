...
public final class AdministradorCategoriaEntities {
	
	private static final AdministradorCategoriaEntities DEFAULT_OBJECT = new AdministradorCategoriaEntities();
	...
	private EstadoAdministradorCategoriaEntities estado;
	
	private AdministradorCategoriaEntities() {
		super();
		...
		setEstado(EstadoAdministradorCategoriaEntities.getDefaultObject());
	}
	
	public AdministradorCategoriaEntities(UUID identificador, TipoIdentificacionEntities tipoIdentificacion,
			...
			EstadoAdministradorCategoriaEntities estado) {
		super();
	...
	public static AdministradorCategoriaEntities getDefaultObject() {
	...
	public final EstadoAdministradorCategoriaEntities getEstado() {
		return estado;
	}

	private final void setEstado(final EstadoAdministradorCategoriaEntities estado) {
		this.estado = UtilObject.getDefault(estado, EstadoAdministradorCategoriaEntities.getDefaultObject());
	}
}
