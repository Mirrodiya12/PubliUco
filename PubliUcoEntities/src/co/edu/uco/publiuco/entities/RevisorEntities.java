...
public class RevisorEntities {
	
	private static final RevisorEntities DEFAULT_OBJECT = new RevisorEntities();
	...
	private EstadoRevisorEntities estado;
	
	private RevisorEntities() {
		super();
		...
		setEstado(EstadoRevisorEntities.getDefaultObject());
	}
	
	public RevisorEntities(UUID identificador, TipoIdentificacionEntities tipoIdentificacion,
	...
	public static RevisorEntities getDefaultObject() {
	...
	public final EstadoRevisorEntities getEstado() {
		return estado;
	}

	private final void setEstado(final EstadoRevisorEntities estado) {
		this.estado = UtilObject.getDefault(estado, EstadoRevisorEntities.getDefaultObject());
	}
}
