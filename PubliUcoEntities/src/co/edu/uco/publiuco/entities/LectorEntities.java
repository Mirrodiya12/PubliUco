...
public class LectorEntities {
	
	private static final LectorEntities DEFAULT_OBJECT = new LectorEntities();
	...
	public LectorEntities(UUID identificador, TipoIdentificacionEntities tipoIdentificacion,
	...
	public static LectorEntities getDefaultObject() {
	...
	private final void setEstado(final EstadoLectorEntities estado) {
