...
public final class EstadoVersionDTO{
	...
	public static final EstadoVersionDTO create() {
		return new EstadoVersionDTO();
	}
	
	public EstadoVersionDTO(final UUID identificador, final String nombre, final String descripcion) {
		super();
